...
<details>
<summary><b>All public repositories</b> — grouped by topic · auto-updated 2026-07-30</summary>
...
- [await-approval](https://github.com/bounded-systems/await-approval) — In-house manual-approval gate for GitHub Actions: pause a job on an issue until an allowlisted approver comments. SHA-pin when consuming.
