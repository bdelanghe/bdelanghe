...
<details>
<summary><b>All public repositories</b> — grouped by topic · auto-updated 2026-06-27</summary>
...
- [site-mcp](https://github.com/bdelanghe/site-mcp) — MCP server over robertdelanghe.dev's signed static API — read-only, verifies responses against the site's content-addressed manifest. `TypeScript`
